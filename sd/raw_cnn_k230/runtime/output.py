...
def pack_alarm_values(base_module, values, error_codes, scale):
...
def build_slot_error_codes(base_module, output_cfg, output_source_by_name, channel_raw_error_codes, full_gas_alarm, value_count):
...
def send_uart_prediction_frame(
    ...
    if raw_anomaly_enabled or full_gas_enabled:
        ...
        packed_values = pack_alarm_values(base_module, tx_values, error_codes, uart_sender.scale)
